...
function switchView(view) {
    ...
    if(el.listControlsBar) {
        if (['history', 'queue', 'recent'].includes(view)) el.listControlsBar.style.display = 'none';
        else el.listControlsBar.style.display = 'flex';
    }

    const bannerDiv = document.getElementById('list-banner');
    bannerDiv.style.display = 'none'; // Default hidden
